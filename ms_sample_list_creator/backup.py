...
#             self.standby_path_button = ttk.Button(
...
#             self.data_path_button = ttk.Button(
...
#         # Back button
#         button_back = ttk.Button(self.new_batch_window, text="Back to Home", width=20, command=self.on_exit)
...
#         button_submit = ttk.Button(self.csv_batch_window, text="Submit", width=17, command=self.submit_result, pady=10)
#         button_submit.pack()

#         button_back = ttk.Button(self.csv_batch_window, text="Go back to home", width=17, command=self.on_exit, pady=10)
#         button_back.pack()
